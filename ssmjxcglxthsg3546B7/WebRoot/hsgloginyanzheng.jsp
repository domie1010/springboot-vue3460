...
<html>
 ...
 if(cx.equals("员工")){sql="select * from yuangongxinxi where bianhao='"+uid+"' and mima='"+pwd+"'";}
 if(cx.equals("采购员")){sql="select * from caigouyuan where bianhao='"+uid+"' and mima='"+pwd+"'";}
 if(cx.equals("员工")){sql="select * from yuangongxinxi where bianhao='"+uid+"' and mima='"+pwd+"'";}
 if(cx.equals("仓库管理")){sql="select * from cangkuguanli where bianhao='"+uid+"' and mima='"+pwd+"'";}
 if(cx.equals("采购员")){sql="select * from caigouyuan where bianhao='"+uid+"' and mima='"+pwd+"'";}
 if(cx.equals("销售员")){sql="select * from xiaoshouyuan where bianhao='"+uid+"' and mima='"+pwd+"'";}
 if(cx.equals("员工")){sql="select * from yuangongxinxi where bianhao='"+uid+"' and mima='"+pwd+"'";}
 //quxanxiaxndexnglxu
