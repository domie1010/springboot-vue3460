...
function gows()
{
	document.location.href="caigouyuan_add.jsp?id=<%=id%>";
}
function hsgxia2shxurxu(nstr,nwbk)
{
	...
	<body>
			<form action="updateCaigouyuan.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="20" colspan="2" background="images/table_header.gif">修改采购员<input type="hidden" name="id" value="${caigouyuan.id}" /></td>
						</tr>
						...
						<script language="javascript">document.form1.bianhao.value='${caigouyuan.bianhao}';</script>	<script language="javascript">document.form1.mima.value='${caigouyuan.mima}';</script>	<script language="javascript">document.form1.xingming.value='${caigouyuan.xingming}';</script>	<script language="javascript">document.form1.xingbie.value='${caigouyuan.xingbie}';</script>	<script language="javascript">document.form1.nianling.value='${caigouyuan.nianling}';</script>	<script language="javascript">document.form1.gongzhong.value='${caigouyuan.gongzhong}';</script>	<script language="javascript">document.form1.ruzhishijian.value='${caigouyuan.ruzhishijian}';</script>	<script language="javascript">document.form1.beizhu.value='${caigouyuan.beizhu}';</script>	
					 </table>
			</form>
   </body>
</html>
