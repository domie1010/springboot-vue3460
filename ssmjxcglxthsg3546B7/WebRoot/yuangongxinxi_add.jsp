...
function hsgxia2shxurxu(nstr,nwbk)
{
	...
	<body>
		...
		<tr ><td width="200">工种：</td><td><select name='gongzhong' id='gongzhong'><option value="普通员工">普通员工</option><option value="采购员">采购员</option><option value="仓库管理">仓库管理</option><option value="销售员">销售员</option></select></td></tr>
