...
function gows()
{
	document.location.href="chanpinxinxi_add.jsp?id=<%=id%>";
}
function hsgxia2shxurxu(nstr,nwbk)
{
	...
	<body>
			<form action="addChanpinxinxi.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="20" colspan="2" background="images/table_header.gif">添加产品信息</td>
						</tr>
		...
		<tr ><td width="200">类别：</td><td><select name='leibie' id='leibie' style=' height:19px; border:solid 1px #000000; color:#666666'><%=connDbBean.hsggetoption("chanpinleibie","leibie")%></select>&nbsp;*<label id='clabelleibie' /></td></tr>
		...
		<tr ><td width="200">库存：</td><td><input name='kucun' type='text' id='kucun' value='' onblur='' style='border:solid 1px #000000; color:#666666' /></td></tr>
...
function hsgcheck() {
		...
		if(bianhao==""||(bianhao.length<0||bianhao.length>12)){
