...
function gows()
{
	document.location.href="cangkuguanli_add.jsp?id=<%=id%>&bianhao="+document.form1.bianhao.value;
}
function hsgxia2shxurxu(nstr,nwbk)
{
	...
	<body>
			<form action="addCangkuguanli.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="20" colspan="2" background="images/table_header.gif">添加仓库管理</td>
						</tr>
...
%>
<script language="javascript">
document.form1.bianhao.value="<%=connDbBean.readzd("yuangongxinxi","bianhao","bianhao",request.getParameter("bianhao"))%>";document.form1.mima.value="<%=connDbBean.readzd("yuangongxinxi","mima","bianhao",request.getParameter("bianhao"))%>";document.form1.xingming.value="<%=connDbBean.readzd("yuangongxinxi","xingming","bianhao",request.getParameter("bianhao"))%>";document.form1.xingbie.value="<%=connDbBean.readzd("yuangongxinxi","xingbie","bianhao",request.getParameter("bianhao"))%>";document.form1.nianling.value="<%=connDbBean.readzd("yuangongxinxi","nianling","bianhao",request.getParameter("bianhao"))%>";document.form1.gongzhong.value="<%=connDbBean.readzd("yuangongxinxi","gongzhong","bianhao",request.getParameter("bianhao"))%>";document.form1.ruzhishijian.value="<%=connDbBean.readzd("yuangongxinxi","ruzhishijian","bianhao",request.getParameter("bianhao"))%>";
